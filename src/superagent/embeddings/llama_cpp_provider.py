...
class LlamaCppEmbeddingProvider(EmbeddingProvider):
    """HTTP provider for llama.cpp embeddings."""
    ...
    def embed(self, request: EmbeddingRequest) -> EmbeddingResponse:
        ...
        if self.settings.embedding_model_id:
            payload["model"] = self.settings.embedding_model_id
        try:
        ...
        return EmbeddingResponse(embeddings=embeddings, provider_name="llama.cpp")
