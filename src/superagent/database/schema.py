...
PHASE3_MIGRATION_STATEMENTS: tuple[str, ...] = (
    ...
    CREATE TABLE IF NOT EXISTS document_versions (
        ...
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL,
        FOREIGN KEY(document_id) REFERENCES knowledge_documents(document_id) ON DELETE RESTRICT
    )
    """,
    """
    ...
    CREATE TABLE IF NOT EXISTS embedding_records (
        ...
        created_at TEXT NOT NULL,
        updated_at TEXT NOT NULL,
        FOREIGN KEY(chunk_id) REFERENCES knowledge_chunks(chunk_id) ON DELETE RESTRICT,
        FOREIGN KEY(document_id) REFERENCES knowledge_documents(document_id) ON DELETE RESTRICT,
        FOREIGN KEY(version_id) REFERENCES document_versions(version_id) ON DELETE SET NULL
    )
    """,
    ...
    CREATE TABLE IF NOT EXISTS knowledge_items (
        ...
        FOREIGN KEY(document_id) REFERENCES knowledge_documents(document_id) ON DELETE RESTRICT,
        FOREIGN KEY(version_id) REFERENCES document_versions(version_id) ON DELETE SET NULL,
        FOREIGN KEY(chunk_id) REFERENCES knowledge_chunks(chunk_id) ON DELETE SET NULL
    )
    """,
    """
    ...
    """,
    """
    CREATE TABLE IF NOT EXISTS lexical_index_entries (
        entry_id TEXT PRIMARY KEY,
